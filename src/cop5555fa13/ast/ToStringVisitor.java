...
public class ToStringVisitor implements ASTVisitor {
	...
	public Object visitDec(Dec dec, Object arg) {
		sb.append(arg).append("Dec:").append(dec.type).append(" ")
	...
	public Object visitProgram(Program program, Object arg) throws Exception {
		sb.append(arg).append("Program:").append(program.ident.getText());
		String indent = arg + "  ";
	...
	public Object visitAlternativeStmt(AlternativeStmt alternativeStmt,
		...
		sb.append(arg).append("AlternativeStmt:\n");
		String indent0 = arg + "  ";
	...
	public Object visitPauseStmt(PauseStmt pauseStmt, Object arg)
			throws Exception {
		sb.append(arg).append("PauseStatement:\n");
		String indent = arg + "  ";
	...
	public Object visitIterationStmt(IterationStmt iterationStmt, Object arg)
			throws Exception {
		sb.append(arg).append("IterationStmt:\n");
		String indent = arg + "  ";
	...
	public Object visitAssignPixelStmt(AssignPixelStmt assignPixelStmt,
			Object arg) throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("AssignPixelStmt:\n").append(indent);
	...
	public Object visitAssignExprStmt(AssignExprStmt assignExprStmt, Object arg)
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("AssignExprStmt:").append('\n').append(indent)
				.append(assignExprStmt.lhsIdent.getText()).append('\n');
	...
	public Object visitSinglePixelAssignmentStmt(
			...
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("SinglePixelAssignmentStmt:\n").append(indent)
	...
	public Object visitSingleSampleAssignmentStmt(
			...
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("SingleSampleAssignmentStmt:\n").append(indent)
	...
	public Object visitScreenLocationAssignmentStmt(
			...
			Object arg) throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("ScreenLocationAssignmentStmt:\n").append(indent)
				.append(screenLocationAssignmentStmt.lhsIdent).append('\n');
	...
	public Object visitShapeAssignmentStmt(
			...
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("ShapeAssignmentStmt:\n").append(indent)
				.append(shapeAssignmentStmt.lhsIdent).append('\n');
	...
	public Object visitSetVisibleAssignmentStmt(
			...
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("SetVisibleAssignmentStmt:\n").append(indent)
				.append(setVisibleAssignmentStmt.lhsIdent).append('\n');
		setVisibleAssignmentStmt.expr.visit(this, indent);
		return null;
	}

	@Override
	public Object FileAssignStmt(FileAssignStmt fileAssignStmt, Object arg)
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("FileAssignStmt:\n").append(indent)
				.append(fileAssignStmt.lhsIdent).append('\n').append(indent)
	...
	public Object visitConditionalExpr(ConditionalExpr conditionalExpr,
			Object arg) throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("ConditionalExpr:\n");
	...
	public Object visitBinaryExpr(BinaryExpr binaryExpr, Object arg)
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("BinaryExpr:\n");
		binaryExpr.e0.visit(this, indent);
		sb.append(indent).append(binaryExpr.op.getText()).append('\n');
	...
	public Object visitSampleExpr(SampleExpr sampleExpr, Object arg)
			throws Exception {
		String indent = arg + "  ";
		sb.append(arg).append("SampleExpr:\n")
				.append(sampleExpr.ident.getText()).append('\n');
		sampleExpr.xLoc.visit(this, indent);
		sb.append('\n');
		sampleExpr.yLoc.visit(this, indent);
		sb.append(indent).append(sampleExpr.color);
		return null;
	}
	...
	public Object visitImageAttributeExpr(
		...
		String indent = arg + "  ";
		sb.append(arg).append("ImageAttributeExpr:\n").append(indent)
				.append(imageAttributeExpr.ident.getText()).append('\n')
				.append(indent).append(imageAttributeExpr.selector.getText());
		return null;
	}
	...
	public Object visitIdentExpr(IdentExpr identExpr, Object arg)
			throws Exception {
		sb.append(arg).append("IdentExpr: ").append(identExpr.ident.getText());
		return null;
	}
	...
	public Object visitIntLitExpr(IntLitExpr intLitExpr, Object arg)
			throws Exception {
		sb.append(arg).append("IntLitExpr: ")
	...
	public Object visitBooleanLitExpr(BooleanLitExpr booleanLitExpr, Object arg)
			throws Exception {
		sb.append(arg).append("BooleanLitExpr: ")
	...
	public Object visitPreDefExpr(PreDefExpr PreDefExpr, Object arg)
			throws Exception {
		sb.append(arg).append("PreDefExpr: ")
